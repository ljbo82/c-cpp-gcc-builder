...
class BuildSystemTest(unittest.TestCase, TestBase):
	...
	def test_proj_name_reject_empty(self):
		result = self.make(make_flags='-f proj_name_empty.mk')
	...
	def test_proj_version_default_value(self):
		result = self.make(make_flags='-f proj_version_default.mk print-vars VARS=PROJ_VERSION')
