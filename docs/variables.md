...
!!! note "Variable details"
    ...
    * **Origin:** Contains information about allowed origins for variable definition.
...
* **Mutable:** No
* **Origin:** The variable can be declared through any origin, although it is strongly recommended to define this variable through command-line parameters.
...
* **Mutable:** yes
* **Origin:** _Any, although it is strongly recommended to define this variable through command-line parameters._
* **Restrictions:**
...
* **Mutable:** yes
* **Origin:** _(N/A: variable is set by the build system)_
